...
static const struct entropy_driver_api entropy_ft_trng_api_funcs = {.get_entropy = entropy_ft_trng_get_entropy};
...
DEVICE_DT_INST_DEFINE(0, entropy_ft_trng_init, NULL, NULL, NULL, POST_KERNEL, CONFIG_ENTROPY_INIT_PRIORITY,
