...
static int wdt_ft_install_timeout(const struct device *dev,
...
DEVICE_DT_INST_DEFINE(0, wdt_ft_init, NULL, &wdt_data, &wdt_cfg, POST_KERNEL,
		      CONFIG_KERNEL_INIT_PRIORITY_DEVICE, &wdt_ft_api);
