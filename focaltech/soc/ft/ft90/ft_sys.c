...
static void DRV_XIP_SYSCLKSwitch(uint8_t sys_clk_div, uint16_t ssi_clk_div, uint32_t ssi_rx_sample_delay)
{
    ...
    xip_sys_clk_switch(&ssi_cfg[ssi_id - 1]);
}
...
static void DRV_DCACHE_Init(CACHE_ComTypeDef boot,
...
static void DRV_ICACHE_Init(CACHE_ComTypeDef boot,
                     CACHE_ComTypeDef rom,
                     CACHE_ComTypeDef spim1,
                     CACHE_ComTypeDef spim2,
                     CACHE_ComTypeDef spim3)
...
{
    //void DRV_DCACHE_Init(uint32_t,uint32_t,uint32_t,uint32_t,uint32_t,uint32_t);
   // void DRV_ICACHE_Init(uint32_t,uint32_t,uint32_t,uint32_t,uint32_t,uint32_t);
//#define CACHE_BASE_ADDR (0x40051000)
//#define CACHE2_BASE_ADDR (0x40055000)
    DRV_DCACHE_Init(CACHE_Through,
                    CACHE_Through,
                    CACHE_Through,
                    CACHE_Through,
                    CACHE_Off);
